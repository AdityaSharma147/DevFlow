  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl max-w-lg w-full max-h-[80vh] overflow-y-auto p-6"
      >
        ...
        <div className="flex gap-2 mb-4">
          {task.labels.map((label) => (
            <span
              key={label}
              className="text-[10px] bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 px-2 py-0.5 rounded-full"
            >
              {label}
            </span>
          ))}
